...
public class ListenerProjectAmountIsCheckService extends IntentService {

    public ListenerProjectAmountIsCheckService() {
        super("ListenerProjectAmountIsCheckService");
    }
