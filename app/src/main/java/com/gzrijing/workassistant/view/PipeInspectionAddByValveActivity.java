...
public class PipeInspectionAddByValveActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pipe_inspection_add_by_valve);
    ...
    private void initViews() {
        ...
        tv_item1 = (TextView) findViewById(R.id.pipe_inspection_add_by_valve_item1_tv);
        btn_item1 = (Button) findViewById(R.id.pipe_inspection_add_by_valve_item1_btn);
        et_item2 = (EditText) findViewById(R.id.pipe_inspection_add_by_valve_item2_et);
        et_item3 = (EditText) findViewById(R.id.pipe_inspection_add_by_valve_item3_et);
        et_item3.setText(areaName);
        et_item4 = (EditText) findViewById(R.id.pipe_inspection_add_by_valve_item4_et);
        et_item5 = (EditText) findViewById(R.id.pipe_inspection_add_by_valve_item5_et);
        et_item6 = (EditText) findViewById(R.id.pipe_inspection_add_by_valve_item6_et);
        tv_item7 = (TextView) findViewById(R.id.pipe_inspection_add_by_valve_item7_tv);
        btn_item7 = (Button) findViewById(R.id.pipe_inspection_add_by_valve_item7_btn);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.pipe_inspection_add_by_valve_item1_btn:
                getNo();
                break;


            case R.id.pipe_inspection_add_by_valve_item7_btn:
                initMyLocation();
    ...
    public class MyLocationListener implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation bdLocation) {
            ...
            Intent intent = new Intent(PipeInspectionAddByValveActivity.this, MapPointActivity.class);
        ...
        HttpUtils.sendHttpGetRequest(url, new HttpCallbackListener() {
            ...
            public void onError(Exception e) {
                handler.post(new Runnable() {
                    @Override
                    public void run() {
                        ToastUtil.showToast(PipeInspectionAddByValveActivity.this, "与服务器断开连接", Toast.LENGTH_SHORT);
                        btn_item1.setVisibility(View.VISIBLE);
                    }
                });
            }
