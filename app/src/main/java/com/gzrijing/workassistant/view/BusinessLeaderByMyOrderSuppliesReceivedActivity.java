...
public class BusinessLeaderByMyOrderSuppliesReceivedActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_business_leader_by_my_order_supplies_received);
