...
public class PipeRepairProgressAdapter extends BaseAdapter {
    private Context context;
    private LayoutInflater listContainer;
    private List<PipeRepairProgress> proInfos;

    public PipeRepairProgressAdapter(
            Context context, List<PipeRepairProgress> proInfos) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = listContainer.inflate(
                    R.layout.listview_item_pipe_repair_progress, parent, false);
            v.time = (TextView) convertView.findViewById(
                    R.id.listview_item_pipe_repair_progress_time_tv);
            v.progress = (ImageView) convertView.findViewById(
                    R.id.listview_item_pipe_repair_progress_line_iv);
            v.content = (TextView) convertView.findViewById(
                    R.id.listview_item_pipe_repair_progress_content_tv);
