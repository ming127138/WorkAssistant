    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = listContainer.inflate(
                    R.layout.listview_item_machine_return_edit, parent, false);
            v.del = (ImageView) convertView.findViewById(R.id.listview_item_machine_return_edit_del_iv);
            v.id = (TextView) convertView.findViewById(R.id.listview_item_machine_return_edit_id_tv);
            v.name = (TextView) convertView.findViewById(R.id.listview_item_machine_return_edit_name_tv);
            v.unit = (TextView) convertView.findViewById(R.id.listview_item_machine_return_edit_unit_tv);
            v.num = (TextView) convertView.findViewById(R.id.listview_item_machine_return_edit_num_tv);
